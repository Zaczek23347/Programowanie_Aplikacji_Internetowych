<?php
// Wyłącz raportowanie błędów dotyczących noticji i ostrzeżeń.
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);

// Dołącz pliki konfiguracyjny i obsługujący wyświetlanie stron.
include("cfg.php");
include("showpage.php");

// Definiuj ścieżki do poszczególnych stron HTML.
...
// Sprawdź, jaka strona powinna być wyświetlana na podstawie parametru "idp" z żądania GET.
...
if ($_GET['idp'] == 'zrob_zakupy') $strona = './zrob_zakupy.php';
?>
...
<table>
	...
	<div id="navigation"><a href="zrob_zakupy.php">Zakupy</a></div>
	</tr>
<?php
 include($strona);
?>	
